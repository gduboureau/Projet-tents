...
int game_check_move(cgame g, uint i, uint j, square s) {
  ...
  /* Analyse si arbre adj grass puis arbre entour̩ de grass */

  if (i == 0 && j == 0 && s == GRASS) {  // grass plac̩ coin gauche haut
  ...
  if (i == 0 && j == 1 &&
      s == GRASS) {  // grass plac̩ coin gauche haut +1 horizontal
    if (game_get_square(g, i, j - 1) == TREE &&
        (game_get_square(g, i + 1, j - 1) == GRASS ||
         game_get_square(g, i + 1, j - 1) == TREE)) {
      return LOSING;
  ...
  if (i == 0 && j > 1 && j < DEFAULT_SIZE - 2 &&
      s == GRASS) {  // grass plac̩ ligne du haut (i==0), "coin+" exclue
    if (game_get_square(g, i, j - 1) == TREE &&
        (game_get_square(g, i, j - 2) == TREE ||
         game_get_square(g, i, j - 2) == GRASS) &&
        (game_get_square(g, i + 1, j - 1) == TREE ||
  ...
  if (i == 0 && j == DEFAULT_SIZE - 2 &&
      s == GRASS) {  // grass plac̩ coin droit haut -1 horizontal
    if (game_get_square(g, i, j - 1) == TREE &&
        (game_get_square(g, i + 1, j - 1) == TREE ||
         game_get_square(g, i + 1, j - 1) == GRASS) &&
        (game_get_square(g, i, j - 2) == TREE ||
  ...
  if (i == 0 && j == DEFAULT_SIZE - 1 &&
      s == GRASS) {  // grass plac̩ coin droit haut
    if (game_get_square(g, i, j - 1) == TREE &&
        (game_get_square(g, i + 1, j - 1) == TREE ||
         game_get_square(g, i + 1, j - 1) == GRASS) &&
        (game_get_square(g, i, j - 2) == TREE ||
  ...
  if (i == 1 && j == 0 &&
      s == GRASS) {  // grass plac̩ coin gauche haut +1 verticale
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j + 1) == TREE ||
         game_get_square(g, i - 1, j + 1) == GRASS)) {
      return LOSING;
  ...
  if (i == 1 && j == 1 && s == GRASS) {  // grass plac̩ coin gauche haut +1h +1v
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS) &&
        (game_get_square(g, i - 1, j + 1) == TREE ||
  ...
  if (i == 1 && j > 1 && j < DEFAULT_SIZE - 2 &&
      s == GRASS) {  // grass plac̩ 2eme ligne du haut (i==1), "coin+" exclue
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS) &&
        (game_get_square(g, i - 1, j + 1) == TREE ||
  ...
  if (i == 1 && j == DEFAULT_SIZE - 2 &&
      s == GRASS) {  // grass plac̩ coin droit haut -1h +1v
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS) &&
        (game_get_square(g, i - 1, j + 1) == TREE ||
  ...
  if (i == 1 && j == DEFAULT_SIZE - 1 &&
      s == GRASS) {  // grass plac̩ coin droit haut +1 verticale
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS)) {
      return LOSING;
  ...
  if (j == 0 && i > 1 && i < DEFAULT_SIZE - 2 &&
      s == GRASS) {  // grass plac̩ ligne gauche (j==0), "coin+" exclue
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 2, j) == TREE ||
         game_get_square(g, i - 2, j) == GRASS) &&
        (game_get_square(g, i - 1, j + 1) == TREE ||
  ...
  if (j == 1 && i > 1 && i < DEFAULT_SIZE - 2 &&
      s == GRASS) {  // grass plac̩ 2eme ligne gauche (j==1), "coin+" exclue
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS) &&
        (game_get_square(g, i - 2, j) == TREE ||
  ...
  if (j > 1 && j < DEFAULT_SIZE - 2 && i > 1 && i < DEFAULT_SIZE - 2 &&
      s == GRASS) {  // grass plac̩ "centre jeu", "coin+" exclue
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS) &&
        (game_get_square(g, i - 2, j) == TREE ||
  ...
  if (j == DEFAULT_SIZE - 2 && i > 1 && i < DEFAULT_SIZE - 2 &&
      s == GRASS) {  // grass plac̩ ligne droite-1 (j==DEFAULT_SIZE-2), "coin+"
                     // exclue
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS) &&
  ...
  if (j == DEFAULT_SIZE - 1 && i > 1 && i < DEFAULT_SIZE - 2 &&
      s == GRASS) {  // grass plac̩ ligne droite (j==DEFAULT_SIZE-1), "coin+"
                     // exclue
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS) &&
  ...
  if (j == 0 && i == DEFAULT_SIZE - 2 &&
      s == GRASS) {  // grass plac̩ coin gauche bas -1v
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 2, j) == TREE ||
         game_get_square(g, i - 2, j) == GRASS) &&
        (game_get_square(g, i - 1, j + 1) == TREE ||
  ...
  if (j == 1 && i == DEFAULT_SIZE - 2 &&
      s == GRASS) {  // grass plac̩ coin gauche bas -1v +1h
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS) &&
        (game_get_square(g, i - 2, j) == TREE ||
  ...
  if (i == DEFAULT_SIZE - 2 && j > 1 && j < DEFAULT_SIZE - 2 &&
      s == GRASS) {  // grass plac̩ ligne du bas-1 (i==DEFAULT_SIZE-2), "coin+"
                     // exclue
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS) &&
  ...
  if (j == DEFAULT_SIZE - 2 && i == DEFAULT_SIZE - 2 &&
      s == GRASS) {  // grass plac̩ coin droit bas -1v -1h
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS) &&
        (game_get_square(g, i - 2, j) == TREE ||
  ...
  if (j == DEFAULT_SIZE - 1 && i == DEFAULT_SIZE - 2 &&
      s == GRASS) {  // grass plac̩ coin droit bas -1v
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS)) {
      return LOSING;
  ...
  if (j == 0 && i == DEFAULT_SIZE - 1 &&
      s == GRASS) {  // grass plac̩ coin gauche bas
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 2, j) == TREE ||
         game_get_square(g, i - 2, j) == GRASS) &&
        (game_get_square(g, i - 1, j + 1) == TREE ||
  ...
  if (j == 1 && i == DEFAULT_SIZE - 1 &&
      s == GRASS) {  // grass plac̩ coin gauche bas +1h
    if (game_get_square(g, i, j - 1) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS)) {
      return LOSING;
  ...
  if (i == DEFAULT_SIZE - 1 && j > 1 && j < DEFAULT_SIZE - 2 &&
      s == GRASS) {  // grass plac̩ ligne du bas (i==DEFAULT_SIZE-1), "coin+"
                     // exclue
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS) &&
  ...
  if (j == DEFAULT_SIZE - 2 && i == DEFAULT_SIZE - 1 &&
      s == GRASS) {  // grass plac̩ coin droit bas -1h
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS) &&
        (game_get_square(g, i - 2, j) == TREE ||
  ...
  if (j == DEFAULT_SIZE - 1 && i == DEFAULT_SIZE - 1 &&
      s == GRASS) {  // grass plac̩ coin droit bas
    if (game_get_square(g, i - 1, j) == TREE &&
        (game_get_square(g, i - 1, j - 1) == TREE ||
         game_get_square(g, i - 1, j - 1) == GRASS) &&
        (game_get_square(g, i - 2, j) == TREE ||
