...
            if(game_get_square(g, i, j) != TENT || game_get_square(g, i, j) != TREE || game_get_square(g, i, j) != GRASS || game_get_square(g, i, j) != EMPTY){
...
/* bool test_game_set_expected_nb_tents_row(game g, uint i, uint nb_tents){
...
/* bool test_game_set_expected_nb_tents_col(game g, uint j, uint nb_tents){
    }
*/
...
/* bool test_game_get_current_nb_tents_all(cgame g){
    }
*/
/* *********************************************************** */
